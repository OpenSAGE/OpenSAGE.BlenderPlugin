...
class Shader:
    ...
    def write(self, io_stream):
        write_ubyte(int(self.depth_compare), io_stream)
        write_ubyte(int(self.depth_mask), io_stream)
        write_ubyte(self.color_mask, io_stream)
        write_ubyte(int(self.dest_blend), io_stream)
        write_ubyte(self.fog_func, io_stream)
        write_ubyte(int(self.pri_gradient), io_stream)
        write_ubyte(int(self.sec_gradient), io_stream)
        write_ubyte(int(self.src_blend), io_stream)
        write_ubyte(int(self.texturing), io_stream)
        write_ubyte(int(self.detail_color_func), io_stream)
        write_ubyte(int(self.detail_alpha_func), io_stream)
        write_ubyte(self.shader_preset, io_stream)
        write_ubyte(int(self.alpha_test), io_stream)
        write_ubyte(int(self.post_detail_color_func), io_stream)
        write_ubyte(int(self.post_detail_alpha_func), io_stream)
