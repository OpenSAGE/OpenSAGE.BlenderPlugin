...
def retrieve_shader_material(material, principled, w3x=False):
    ...
    if w3x:
        ...
        append_property(shader_mat, 2, 'SpecularExponent', material.specular_intensity * 255.0, 122.5)
    ...
    if principled.normalmap_texture is not None:
        append_property(shader_mat, 2, 'BumpScale', principled.normalmap_strength, 122.5)
