...
def create_animation(context, rig, animation, hierarchy):
    ...
    if rig is not None and rig.data is not None and rig.data.animation_data is not None and rig.data.animation_data.action is not None:
